...
export const zh = {
  ...
  capImageOnly: '仅图片',
  capNone: '—',
  capVideoFootnote: '* 模型接受视频输入，但当前版本尚无视频上传入口，实际不会发出视频内容块。',
...
export const en = {
  ...
  capImageOnly: 'Images',
  capNone: '—',
  capVideoFootnote: '* The model accepts video input, but this build has no video upload path yet, so no video part is ever sent.',
