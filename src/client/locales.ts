...
export const zh = {
  ...
  contextWindowsHint: 'GPT-6 系列默认 384K（最高 872K），GPT-5.6 系列默认 272K（最高 1M）。该值用于 DSH 的压缩与溢出判断，可输入 872K、512K 等容量。',
  contextWindow: '上下文窗口',
  contextWindowInvalid: '上下文窗口必须是正整数，且不能超过模型上限（GPT-6 系列为 872K，GPT-5.6 系列为 1M）；可使用 K 或 M 后缀。',
...
export const en: Record<keyof typeof zh, string> = {
  ...
  contextWindowsHint: 'GPT-6 defaults to 384K (up to 872K); GPT-5.6 defaults to 272K (up to 1M). DSH uses it for compaction and overflow detection; values such as 872K and 512K are accepted.',
  contextWindow: 'Context window',
  contextWindowInvalid: 'The context window must be a positive integer within the model limit (872K for the GPT-6 family, 1M for GPT-5.6). K and M suffixes are accepted.',
