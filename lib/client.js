window.__ModuleLoader__.load({
	...
	factory: (require) => {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("proxyMode") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											disabled: busy !== null,
											onChange: () => updatePreferences({ proxyMode: "auto" })
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("proxyModeAuto") })] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											type: "radio",
											name: "dsh-codex-proxy-mode",
											checked: status?.preferences.proxyMode === "custom",
											disabled: busy !== null,
											onChange: () => updatePreferences({ proxyMode: "custom" })
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("proxyModeCustom") })] }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											type: "radio",
											name: "dsh-codex-proxy-mode",
											checked: status?.preferences.proxyMode === "direct",
											disabled: busy !== null,
											onChange: () => updatePreferences({ proxyMode: "direct" })
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("proxyModeDirect") })] })
									]
								})]
							}), status?.preferences.proxyMode === "custom" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("customProxyUrl") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
										htmlFor: "dsh-codex-custom-proxy",
										children: t("customProxyUrl")
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("subagentReasoningEffort") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										...
										value: status?.preferences.subagentReasoningEffort ?? "",
										disabled: busy !== null,
										onChange: (event) => {
											const value = event.currentTarget.value;
											updatePreferences({ subagentReasoningEffort: value === "" ? null : value });
										},
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "",
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "none",
												children: reasoningEffortLabel$1("none", t)
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "low",
												children: reasoningEffortLabel$1("low", t)
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "medium",
												children: reasoningEffortLabel$1("medium", t)
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "high",
												children: reasoningEffortLabel$1("high", t)
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "xhigh",
												children: reasoningEffortLabel$1("xhigh", t)
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
												value: "max",
												children: reasoningEffortLabel$1("max", t)
											})
										]
									})]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t("subagentMaxDepth") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										...
										value: status?.preferences.subagentMaxDepth === null || status?.preferences.subagentMaxDepth === void 0 ? "" : String(status.preferences.subagentMaxDepth),
										disabled: busy !== null,
										onChange: (event) => {
											const value = event.currentTarget.value;
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
													...
													value: subagentContextDraft ?? (status?.preferences.subagentContextWindow ? formatCapacity(status.preferences.subagentContextWindow) : ""),
													disabled: busy !== null,
								...
								status?.allProviders?.filter((p) => p.id !== "codex-chatgpt" && p.models.some((m) => m.reasoningEfforts.length > 0)).map((provider) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dsh-codex-context-settings",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", { children: [
										provider.name,
										" ",
										t("subagentEnhancements")
									] }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										className: "dsh-codex-muted",
										children: t("allSubagentReasoningHint")
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											className: "dsh-codex-pref-row",
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: model.name }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", {
												className: "dsh-codex-muted",
												style: {
													display: "block",
													fontSize: 11
												...
												onChange: (event) => {
													const value = event.currentTarget.value;
													updatePreferences({ subagentModelEfforts: { [modelKey]: value === "" ? null : value } });
												},
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
													value: "",
													children: t("providerDefault")
												}), model.reasoningEfforts.map((effort) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
													value: effort,
													children: reasoningEffortLabel$1(effort, t)
												}, effort))]
											})]
										}, modelKey);
									})]
		...
		function reasoningEffortLabel$1(effort, t) {
			return t({
				none: "reasoningNone",
				low: "reasoningLow",
		...
		const zh = {
			...
			subagentEnhancements: "子代理偏好",
			subagentReasoningEffort: "子代理默认思考深度",
			subagentReasoningEffortHint: "当主 Agent 派发子代理且未显式指定推理深度时，使用此默认值。",
			allSubagentReasoning: "全供应商模型思考深度管理",
			allSubagentReasoningHint: "为系统内所有已接入供应商（Codex、DeepSeek、Kimi 等）的模型配置默认思考强度。",
			subagentModelSelectionChoose: "开启后，Agent 可以从下方授权模型中为每个 Subagent 选择提供方、模型和推理强度。",
			subagentModelSelectionAllowed: "Agent 可选择的模型与默认思考强度",
			discard: "放弃修改",
			saving: "保存中…",
		...
		const dictionaries = {
			...
			en: {
				...
				subagentEnhancements: "Subagent preferences",
				subagentReasoningEffort: "Subagent default reasoning effort",
				subagentReasoningEffortHint: "Used when the parent Agent delegates to a subagent without specifying reasoning effort.",
				allSubagentReasoning: "Multi-Provider Subagent Reasoning",
				allSubagentReasoningHint: "Configure default reasoning effort for all providers and models (Codex, DeepSeek, Kimi, etc.) when delegated as a subagent.",
				subagentModelSelectionChoose: "When enabled, agents can choose a provider, model, and reasoning effort for each subagent from authorized models below.",
				subagentModelSelectionAllowed: "Models agents may choose and default reasoning",
				discard: "Discard",
				saving: "Saving…",
		...
		//#endregion
		//#region src/client/EnhancedSubagentModelSelectionCard.tsx
		function EnhancedSubagentModelSelectionCard(props) {
			const t = props.t;
			const [status, setStatus] = (0, react.useState)(null);
			const [loading, setLoading] = (0, react.useState)(true);
			const [saving, setSaving] = (0, react.useState)(false);
			const [maxDepth, setMaxDepth] = (0, react.useState)(null);
			const [contextBudget, setContextBudget] = (0, react.useState)(null);
			const [modelEfforts, setModelEfforts] = (0, react.useState)({});
			const [dirty, setDirty] = (0, react.useState)(false);
			const api = react.default.useMemo(() => new SubscriptionApi(), []);
			...
			const handleEffortChange = (modelKey, effort) => {
			...
			const groups = status?.allProviders ?? [];
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", {
						...
						children: t("subagentEnhancements")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						className: "dsh-codex-muted",
						style: {
							margin: 0,
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
									className: "dsh-codex-select",
									"aria-label": t("subagentMaxDepth"),
									value: maxDepth === null || maxDepth === void 0 ? "" : String(maxDepth),
									disabled: saving,
									onChange: (e) => {
							...
							children: groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									style: {
										fontSize: 12,
										fontWeight: 600,
										color: "var(--dsw-alias-brand-primary, #4b89ff)",
										marginBottom: 8
									},
									children: group.name
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
									...
									children: group.models.map((model) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
												...
												children: modelKey
											})] }), hasEfforts ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
												className: "dsh-codex-select",
												"aria-label": `${model.name} ${t("subagentReasoningEffort")}`,
												value: currentEffort,
												disabled: saving,
						...
						dirty ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								...
								className: "dsh-codex-button primary",
								type: "button",
								disabled: saving,
								onClick: handleSave,
