	...
	factory: (require) => {
		...
		*/
		...
		const zh$1 = {
			...
			wireAnthropic: "Anthropic",
			wireOpenai: "OpenAI",
			capVideo: "视频输入（k3 / kimi-for-coding 支持；控制器可发送 video_url 内容块）",
			capDynamicTools: "动态工具加载（仅 K3）：可在会话中途以无 content 的 system 消息注入完整工具定义，保持顶层 tools 稳定以保护前缀缓存",
			capPlan: "需要套餐：{plan}",
			speedRegular: "标准",
		...
		const en$1 = {
			...
			wireAnthropic: "Anthropic",
			wireOpenai: "OpenAI",
			capVideo: "Video input (k3 / kimi-for-coding accept it; the controller can send video_url parts)",
			capDynamicTools: "Dynamically loaded tools (K3 only): full tool definitions injected mid-session as a content-less system message, keeping the top-level tools array stable for the prefix cache",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							status?.models.some((model) => model.supportsVideo || model.supportsDynamicTools || model.description) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dsha-context-settings",
								children: status.models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dsha-context-row",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										...
										children: [
											model.name,
											model.supportsVideo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "dsha-model-meta",
												children: t.capVideo
											}),
											model.supportsDynamicTools && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: "dsha-model-meta",
