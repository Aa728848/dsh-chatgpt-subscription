window.__ModuleLoader__.load({
	...
	factory: (require) => {
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(Section, {
							...
							children: [
								...
								status?.authenticated ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)(InfoRow, {
										label: t("expires"),
										value: formatDate$2(account?.tokenExpiresAt)
									})
								] }) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(InfoRow, {
									label: t("storage"),
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("label", {
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
														...
														type: "text",
														inputMode: "numeric",
														value: draft ?? formatCapacity$2(fallback),
														disabled: busy !== null,
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", { children: [
							...
							": ",
							resetCredits.expiresAt == null ? t("unknown") : formatReset$1(resetCredits.expiresAt)
						] })
					]
				}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Button, {
					primary: true,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: percent >= 100 ? `${t("exhausted")} · ${formatPercent(remaining)} ${t("remaining")}` : `${formatPercent(percent)} ${t("used")} · ${formatPercent(remaining)} ${t("remaining")}` }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: window?.resetsAt == null ? "—" : `${t("resets")}: ${formatReset$1(window.resetsAt)}` })]
					})
				]
			});
		}
		...
		function parseCapacity(value, maxContextWindow = GPT_56_MAX_CONTEXT_WINDOW) {
			const parsed = parsePositiveCapacity$2(value);
		...
		function individualLimitLabel(limit, t) {
			const parts = [
				...
				limit.resetsAt !== null && limit.resetsAt !== void 0 ? `${t("resets")}: ${formatReset$1(limit.resetsAt)}` : null
		...
		function formatReset$1(seconds) {
			if (seconds === void 0 || seconds === null || typeof seconds !== "number" || !Number.isFinite(seconds) || seconds <= 0) return "—";
			const ms = seconds > 1e10 ? seconds : seconds * 1e3;
		...
		function AntigravitySection({ onModelChange, loadModelDirectory }) {
			...
			const loadStatus = (0, react.useCallback)(async (quiet = false) => {
				...
				try {
					...
					for (const m of data.models) {
						...
						drafts[m.id] = formatCapacity$1(val);
					}
					setContextDrafts(drafts);
				} catch (err) {
			...
			const handleLogin = async () => {
				try {
					...
					const flow = await fetchApi$3("/login", { method: "POST" });
					if (flow.authUrl) window.open(flow.authUrl, "_blank");
					const pollTimer = setInterval(async () => {
						try {
							const pollStatus = await fetchApi$3("/login/status");
							...
							status?.authenticated && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										className: "dsha-value",
										children: formatDate$1(Date.now() + 864e5 * 30)
									})]
								})
							] }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function CommandCodeSection({ onModelChange, loadModelDirectory }) {
			...
			const handleLogin = async () => {
				try {
					...
					const pollTimer = window.setInterval(() => {
						(async () => {
							try {
								const poll = await fetchApi$1("/login/status");
			...
			const handleApiKey = async () => {
				try {
					setBusy("apikey");
					setError(null);
					const updated = await fetchApi$1("/login/apikey", {
						method: "POST",
			...
			const handleRefreshCatalog = async () => {
				try {
					setBusy("catalog");
					setError(null);
					const updated = await fetchApi$1("/catalog/refresh", { method: "POST" });
					setStatus(updated);
					const drafts = {};
			...
			const handleTestConnection = async () => {
				try {
					setBusy("connection");
					setError(null);
					await fetchApi$1("/connection/test", { method: "POST" });
							...
							status?.authenticated && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
								...
								quota?.subscriptionStatus && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										className: "dsha-value",
										children: [quota.subscriptionStatus, quota.periodEndsAt !== null ? ` · ${t.renews} ${formatDate(quota.periodEndsAt)}` : ""]
									})]
								}),
									...
									quota.windows.map((window) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											window.resetsAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
												className: "dsha-meter-meta",
												children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["Reset: ", formatReset(window.resetsAt)] })
											})
										]
									}, window.id)),
											...
											children: [
												...
												isWindow ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [
														...
														" / ",
														meter.limit ?? "—"
													] }), meter.resetsAt !== null && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["Reset: ", formatReset(meter.resetsAt)] })]
...
`;
  ...
  `;
    ...
    `;
		...
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, dictionaries$2), "dsh-chatgpt-subscription: dictionaries");
			ctx.effect(() => installStyles(), "dsh-chatgpt-subscription: styles");
			ctx.effect(() => ctx.locale.register(NS_ANTIGRAVITY, dictionaries$1), "dsh-antigravity: dictionaries");
			ctx.effect(() => {
				installAntigravityStyles();
				return () => {};
			}, "dsh-antigravity: styles");
			ctx.effect(() => ctx.locale.register(NS_COMMAND_CODE, dictionaries), "dsh-command-code: dictionaries");
			...
			const AntigravitySectionWrapper = () => {
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(AntigravitySection, { onModelChange: handleModelDirectoryReload });
			};
			ctx.slots.inject("settings.section", () => ctx.slots.register({
				name: "settings.section",
				id: "antigravity",
			...
			const CommandCodeSectionWrapper = () => {
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CommandCodeSection, { onModelChange: handleModelDirectoryReload });
			};
			ctx.slots.inject("settings.section", () => ctx.slots.register({
				name: "settings.section",
				id: "command-code",
