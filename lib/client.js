	...
	factory: (require) => {
		...
		*/
		...
		const zh$1 = {
			...
			wireAnthropic: "Anthropic",
			wireOpenai: "OpenAI",
			capVideo: "视频输入（服务支持；DSH 目前只能发送图片）",
			capDynamicTools: "动态工具加载（K3）：可在会话中途以 system 消息注入额外工具定义",
			capPlan: "需要套餐：{plan}",
			speedRegular: "标准",
		...
		const en$1 = {
			...
			wireAnthropic: "Anthropic",
			wireOpenai: "OpenAI",
			capVideo: "Video input (the service accepts it; DSH can send images only)",
			capDynamicTools: "Dynamically loaded tools (K3): extra tool definitions can be injected mid-session as a system message",
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
						...
						children: [
							...
							status?.models.some((model) => model.supportsVideo || model.description) && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								className: "dsha-context-settings",
								children: status.models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									className: "dsha-context-row",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
										title: model.id,
										children: [model.name, model.supportsVideo && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
