...
function toolParametersForCodex(parameters, allowSandboxRetry) {
	...
	if (Array.isArray(cloned.required)) cloned.required = cloned.required.filter((name) => name !== "sandbox_permissions" && name !== "justification");
	return cloned;
}
